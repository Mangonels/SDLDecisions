...
FiniteStateMachineScene::FiniteStateMachineScene()
{
...
void FiniteStateMachineScene::update(float dtime, SDL_Event *event)
{
	...
	//EJECUTAR LA TRAYECTORIA A TRAVÉS DEL CAMINO:
...
void FiniteStateMachineScene::draw()
{
	drawMaze();
	drawCoin();
...
const char* FiniteStateMachineScene::getTitle()
{
	return "SDL Steering Behaviors :: PathFinding1 Demo";
}

void FiniteStateMachineScene::drawMaze()
{
	if (draw_grid)
	{
...
void FiniteStateMachineScene::drawCoin()
{
...
void FiniteStateMachineScene::initMaze()
{
...
bool FiniteStateMachineScene::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D FiniteStateMachineScene::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D FiniteStateMachineScene::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x/CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool FiniteStateMachineScene::isValidCell(Vector2D cell)
{
